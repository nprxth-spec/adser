...
export default function MaintenancePage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex items-center justify-center px-6">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[36rem] w-[36rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-teal-500/10 blur-3xl animate-maintenance-glow" />
      ...
      <div className="relative w-full max-w-xl rounded-xl border border-slate-800 bg-slate-900/75 p-8 shadow-2xl backdrop-blur animate-maintenance-float">
        ...
        <p className="text-sm text-teal-300 font-semibold tracking-wide uppercase animate-fade-in-up">
          Files Go
        </p>
        <h1 className="mt-3 text-3xl font-bold leading-tight animate-fade-in-up-delay-1">
          ระบบอยู่ระหว่างปรับปรุง
        </h1>
        <p className="mt-4 text-slate-300 leading-relaxed animate-fade-in-up-delay-2">
          ขณะนี้เราอยู่ระหว่างอัปเดตระบบเพื่อให้ใช้งานได้ดีขึ้น
          กรุณากลับมาใหม่อีกครั้งในภายหลัง
        </p>
        <p className="mt-2 text-slate-400 text-sm animate-fade-in-up-delay-2">
        ...
        <div className="mt-6 animate-fade-in-up-delay-3">
          ...
          <p className="mt-2 text-xs text-slate-400">กำลังอัปเดตระบบและตรวจสอบความพร้อม...</p>
        </div>
