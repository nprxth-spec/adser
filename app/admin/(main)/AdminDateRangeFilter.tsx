...
export default function AdminDateRangeFilter({
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 z-30 mt-2 w-[620px] max-w-[calc(100vw-2rem)] rounded-xl border border-slate-200 bg-white p-2.5 shadow-lg">
          <DayPicker
            mode="range"
            selected={selected}
            onSelect={applyRange}
            ...
            classNames={{
              ...
              button_previous:
                "h-6 w-6 inline-flex items-center justify-center rounded-md border border-transparent text-slate-600 hover:bg-slate-100",
              button_next:
                "h-6 w-6 inline-flex items-center justify-center rounded-md border border-transparent text-slate-600 hover:bg-slate-100",
              ...
              day_button:
                "h-9 w-9 rounded-md hover:bg-slate-100 aria-selected:opacity-100",
              selected:
