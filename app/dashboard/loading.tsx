  ...
  return (
    <div className="max-w-7xl mx-auto w-full space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-lg border-2 border-dashed border-slate-200 bg-white p-8">
          <div className="mx-auto h-12 w-12 rounded-lg bg-slate-200" />
          <div className="mt-4 h-4 w-52 mx-auto rounded bg-slate-200" />
          <div className="mt-2 h-4 w-40 mx-auto rounded bg-slate-200" />
        </div>
      </div>
