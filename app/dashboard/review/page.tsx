      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky bottom-0 bg-white border-t border-slate-100 px-6 py-4 flex items-center gap-2 rounded-b-lg">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-slate-200 text-xs text-slate-600 hover:bg-slate-50 disabled:opacity-50 transition-colors cursor-pointer"
          >
    ...
    <div className="max-w-7xl mx-auto w-full space-y-6">
      ...
      <div className="mb-6 sm:mb-8 flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-slate-200 text-xs text-slate-500 hover:bg-slate-50 disabled:opacity-50 transition-colors cursor-pointer shrink-0"
        >
